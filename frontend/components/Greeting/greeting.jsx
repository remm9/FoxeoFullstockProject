...
class Greeting extends React.Component { 
    ...
    render() { 
        const welcomePage = this.props.currentUser ? ( //create nav and side bar for currnt user 
                ...
                <div className="loggedin-sidebar">
                    ...
                    <div className="splash-nav">
                            ...
                            <div className="splash-left">
                                ...
                                <Link className="signup-btn" to="" onClick={this.handleSignup}>Join</Link>
                                {/* <Link className="login-btn" to=""onClick={() => props.openModal('login')}>Log In</Link> */}
                                <Link className="login-btn" to=""onClick={this.handleLogin}>Log In</Link>
                            </div>

                            <div className="splash-right-nav">
                                {/* <Link className="new-video-btn" to="" onClick={() => props.openModal('signup')}>+ New Video</Link>    */}
                                <Link className="new-video-btn" to="" onClick={this.handleSignup}>+ New Video</Link>   
                            </div>
